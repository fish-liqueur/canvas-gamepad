...
type ButtonState = 'general' | 'active';

type ButtonType = 'radial' | 'corner';

type SideButtonPositions = 'top-right' | 'bottom-right' | 'top-left' | 'bottom-left';
...
type ButtonDefinitionRadial = ButtonDefinitionGeneral & {
    radius: [number, number];
}

type ButtonDefinitionCorner = ButtonDefinitionGeneral & {
