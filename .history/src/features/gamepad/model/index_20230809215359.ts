...
// import renderGamepad from "./render-buttons";
import { ButtonDefinition, ButtonStyleKit } from "@entities/button";

type ButtonsKit = [ButtonDefinition, ButtonDefinition, ButtonDefinition, ButtonDefinition, ButtonDefinition];
...
export default class Gamepad {
    ...
    private renderButtons(options: CanvasGamepadOptions, activeButton: Button|null = null): Button[] {
        ...
        for (const button of buttons) {
            ...
            buttonsRendered.push( new Button(button, this.context, styleSelected, this.canvasSide));
        }
