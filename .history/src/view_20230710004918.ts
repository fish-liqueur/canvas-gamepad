...
import {ButtonOptions, ButtonDefinition} from "./types.ts";
import { autobind } from "./autobind.ts";
...
export class View {
    ...
    constructor(rootId: string, callback: Function, options: CanvasGamepadOptions) {
    ...
    private renderButtons(options: CanvasGamepadOptions): Button[] {
        ...
        for (let button of buttons) {
            buttons.push( new Button(button, this.context, style));
        }
